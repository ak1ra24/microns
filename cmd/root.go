...
var rootCmd = &cobra.Command{
	Use:   "microns",
	Short: "microns: docker & netns router simulater",
	Long:  `microns`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".microns" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".microns")
	}
